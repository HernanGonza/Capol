...
const LegalPageLayout = ({ title, actualizado, children }: LegalPageLayoutProps) => {
  return (
    <div className="min-h-screen bg-white dark:bg-[#0a0a0f] text-slate-900 dark:text-white">
      <header className="border-b border-slate-200 dark:border-white/10 py-4 px-6">
        <div className="max-w-3xl mx-auto flex items-center justify-between">
          <Link to="/" className="flex items-center gap-3">
            <img src="/logo-capol.webp" alt="CapOL" className="h-9 w-9 rounded-full object-cover" />
      ...
      <main className="max-w-3xl mx-auto px-6 py-12">
        ...
        <p className="text-sm text-slate-400 dark:text-white/30 mb-10">Última actualización: {actualizado}</p>
      ...
      <footer className="border-t border-slate-200 dark:border-white/10 py-8 px-6">
        <div className="max-w-3xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4 text-sm text-slate-400 dark:text-white/30">
